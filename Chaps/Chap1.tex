...
当一个并矢与一个矢量进行点乘操作时，
会得到一个新的矢量。
而单位并矢与矢量点乘则会得到原来的矢量。公式\ref{eq:1.10}被称作基组 $\{\vec{e}_i\}$ 的\emph{完备性关系}。
它其实是公式\ref{eq:1.1}的变形，
...
\begin{equation}
 ...
 \label{eq:1.17}
\end{equation}
这样，如果我们通过公式\ref{eq:1.16}定义矩阵的乘法，
