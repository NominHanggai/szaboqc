...
Feynman首创了这种办法, 
并在他的Nobel讲座上介绍了其想法的演变发展. 
此处引用他的几句话``我其余的工作就是发展了计算技巧, 
用图形来帮助人们更快地分析微扰论. 
这个工具最初基本上是猜出来的.
.
"``即使是从物理学家的层面来讲, 
...
我们就得到了Bartlett与其合作者提出的\mci{双激发多体微扰论(D-MBPT($\infty$))}. 
...
\emph{提示:} 直接证明这个超分子的每个Goldtone图的值都等于$N$乘以单个分子的对应值。
