...
它可以叫做\underline{劈裂价层}(split valence)基组。
内壳层对多数化学性质的贡献很小，
...
表\ref{tab:3.11} 至 \ref{tab:3.13}展示了使用四个基组 STO-3G、4-31G、6-31G* 和 6-31G** 算出的表\ref{tab:3.10}中分子的总能量。
 $\hd$没有内壳层，也不是重原子，
...
\exercise{
利用表 \ref{tab:3.11} 到\ref{tab:3.13}的结果，计算每个基组和在 Hartree-Fock 极限下，以下两个反应的能量差：
\begin{align*}
