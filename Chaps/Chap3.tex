...
\Next
极小基$\hd^+$的系数同样可由对称性决定, 办法与极小基$\hd$一样. 用以上所得系数求解式\eqref{3.234}, 得到极小基$\hd^+$在$R=1.4\au$的轨道能量, 验证它们是
\begin{align*}
...
\end{align*}
\Next
用总电子能量的一般式\eqref{3.184}证明极小基$\hd$的电子能量为
\begin{align*}
...
\begin{figure}[htbp]\centering
	...
	\addplot [domain=.26:6, thick, mark=none, blue] table[y expr=\thisrowno{1}+2.6438] {heh-tot-ener.txt};
